    ...
    return (
        <div className="block md:max-w-md max-w-sm bg-white rounded-xl shadow-md overflow-hidden transform transition duration-500 hover:scale-105 cursor-pointer border-2 border-[#00df9a] h-full w-full -z-10 text-center">
            <div className="p-8">
                ...
                <a href={`https://www.youtube.com/watch?v=${props.embedId}`} className="block mt-1 text-lg leading-tight font-medium text-black hover:underline capitalize" target="_blank" rel="noreferrer">{props.hook}</a>
