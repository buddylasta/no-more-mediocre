export const Cards = () => {
    ...
    return (
        <div className="grid grid-cols-3 grid-rows-2 gap-7 justify-center mt-5">
            {
                skills.map((skill) => (
                    <a href={skill.url} className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
